 ...
 * AppBar expands or shrinks according to isExpanded and offsetWidth.
 * @param {Number} [offsetWidth=0] - Width offset in pixel.
  ...
  render() {
    ...
    return (
      <MuiAppBar
        ...
        style={{
          width: isExpanded === true ? '100%' : `calc(100% - ${offsetWidth}px)`,
        }}
        color='inherit'
      >
        <Toolbar>
