...
/**
 * AppBar provides a fixed svg icon to toggle drawer open status.
 * AppBar expands or shrinks according to drawer open status.
 * @param {Boolean} [props.isDrawerOpen=true] - Drawer open status
 * @param {Function} [props.onDrawerToggle] - Drawer open status change callback
 */
@withStyles(styles)
