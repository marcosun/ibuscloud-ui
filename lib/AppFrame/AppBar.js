 ...
 * AppBar expands or shrinks according to isExpanded and widthOffset.
 * @param {Number} [widthOffset=0] - Width offset in pixel.
  ...
  render() {
    ...
    return (
      <MuiAppBar
        ...
        style={{
          width: isExpanded === true ? '100%' : `calc(100% - ${widthOffset}px)`,
        }}
        color='inherit'
      >
        <Toolbar>
